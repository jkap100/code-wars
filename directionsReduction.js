...
const input1 = ["NORTH", "WEST", "SOUTH", "EAST"];
const input2 = ["NORTH", "SOUTH", "EAST", "WEST", "EAST", "WEST"];

console.log(dirReduc(input));
console.log(dirReduc(input1));
console.log(dirReduc(input2));
